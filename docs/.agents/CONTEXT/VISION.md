...
See [10 — Runtime Architecture](../ARCHITECTURE/runtime-architecture.md) for how this is structured.
...
This principle is the load-bearing reason for the [Voice / VoiceVariant split](../DECISIONS/adr-0001-voice-variant-split.md):
...
[`POST /v1/speech/generate`](../ARCHITECTURE/api-architecture.md).)
...
"OpenRouter for Voice" behaviour, made possible by the [capability contract](../DECISIONS/adr-0003-model-capability-contract.md)
and [Runtime routing](../ARCHITECTURE/runtime-architecture.md). It is a forward-compatible extension of the
...
|---|---|
| A voice belongs to PeakVox, not a model | [ADR-0001](../DECISIONS/adr-0001-voice-variant-split.md): Voice / VoiceVariant split |
| Models are interchangeable providers | [ADR-0002](../DECISIONS/adr-0002-model-as-first-class-entity.md): Model as a first-class entity |
| Capabilities are stable across providers | [ADR-0003](../DECISIONS/adr-0003-model-capability-contract.md): Model Capability Contract |
| The runtime is the product | [10 — Runtime Architecture](../ARCHITECTURE/runtime-architecture.md) |
| One API, stable across model change | [04 — API Architecture](../ARCHITECTURE/api-architecture.md) |
| Voices are economic assets | [05 — Marketplace](../ARCHITECTURE/marketplace-architecture.md), [07 — Monetization](../ARCHITECTURE/monetization-architecture.md) |
| Variants are buildable runtime assets | [ADR-0008](../DECISIONS/adr-0008-voice-variant-build-lifecycle.md): Voice Variant Build Lifecycle |
| Artifacts are versioned, retained, and auditable | [ADR-0009](../DECISIONS/adr-0009-artifact-versioning-and-retention.md): Artifact Versioning and Retention |
| A voice is a Source Asset, not a WAV; PeakVox provisions variants | [ADR-0010](../DECISIONS/adr-0010-voice-source-assets-and-automatic-variant-provisioning.md): Voice Source Assets + Automatic Variant Provisioning |
| A voice's origin is a Creation Source (asset / preset / marketplace / …), not always a WAV | [ADR-0011](../DECISIONS/adr-0011-voice-creation-sources.md): Voice Creation Sources |
| CE = local runtime, Cloud = ecosystem | [01 — Product](../ARCHITECTURE/product-architecture.md) |

Start at [00 — Overview](../ARCHITECTURE/overview.md) for the document map.
