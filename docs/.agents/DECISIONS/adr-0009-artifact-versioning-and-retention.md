...
- **Extended by:** [ADR-0010](adr-0010-voice-source-assets-and-automatic-variant-provisioning.md) —
...
[ADR-0008](adr-0008-voice-variant-build-lifecycle.md) introduced the Voice Variant Build Lifecycle:
...
([Data §3.3](../ARCHITECTURE/data-architecture.md)). This single-value approach cannot represent
version histories, cannot support retention policies, and cannot anchor audit/reproducibility
chains.

Three architectural invariants must be preserved ([ADR-0004](adr-0004-voice-variant-model-separation.md),
[ADR-0008](adr-0008-voice-variant-build-lifecycle.md)):
...
1. Existing variants for that model are marked `deprecated` ([ADR-0008](adr-0008-voice-variant-build-lifecycle.md)).
