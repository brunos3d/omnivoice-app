...
The Phase 0 architecture suite ([`00-VISION`](../../CONTEXT/VISION.md) → [`10-RUNTIME`](../../ARCHITECTURE/runtime-architecture.md))
plus nine ADRs defined the foundation:

| ADR | Decision | Phase |
|---|---|---|
| [0001](../../DECISIONS/adr-0001-voice-variant-split.md) | Voice / VoiceVariant split | P3 |
| [0002](../../DECISIONS/adr-0002-model-as-first-class-entity.md) | Model as a first-class persisted entity | P2 |
| [0003](../../DECISIONS/adr-0003-model-capability-contract.md) | Declared Model Capability Contract | P3.6 |
| [0004](../../DECISIONS/adr-0004-voice-variant-model-separation.md) | Voice ≠ VoiceVariant ≠ Model separation | P3.5 |
| [0005](../../DECISIONS/adr-0005-edition-scoped-model-availability.md) | Edition-scoped model availability | P3.7.5 |
| [0006](../../DECISIONS/adr-0006-voice-variant-realization-types.md) | Open realization-type taxonomy | P3.6 |
| [0007](../../DECISIONS/adr-0007-canonical-model-metadata.md) | Canonical model metadata registry | P2 |
| [0008](../../DECISIONS/adr-0008-voice-variant-build-lifecycle.md) | Voice Variant Build Lifecycle | P3.11 |
| [0009](../../DECISIONS/adr-0009-artifact-versioning-and-retention.md) | Artifact versioning + retention | P3.11 |

The roadmap ([`09-ROADMAP`](../../ROADMAP/ROADMAP.md)) placed these as the CE-side **spine** (P1–P3 +
...
validation is a separate, still-mostly-open program ([`12-PROVIDER-VALIDATION`](../PROVIDER_VALIDATIONS/provider-validation.md)).
...
| ⛔ Kokoro | No adapter, no catalog entry; research-only ([`12`](../PROVIDER_VALIDATIONS/provider-validation.md) §Kokoro). |
| ⛔ Auto Routing (`model="auto"`) | Not implemented; metadata-readiness assessed in [`12`](../PROVIDER_VALIDATIONS/provider-validation.md). |
...
the Voice's reference audio*). See [`12-PROVIDER-VALIDATION`](../PROVIDER_VALIDATIONS/provider-validation.md) §Kokoro.
...
running the provider validation program ([`12`](../PROVIDER_VALIDATIONS/provider-validation.md)) on **one** real
