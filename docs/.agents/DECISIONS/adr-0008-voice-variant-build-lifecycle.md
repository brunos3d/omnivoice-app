...
- **Refined by:** [ADR-0010](adr-0010-voice-source-assets-and-automatic-variant-provisioning.md) —
...
Three binding architectural principles must be preserved ([ADR-0004](adr-0004-voice-variant-model-separation.md)):
