...
> See also: [Overview](overview.md) · [Domain](domain-architecture.md) ·
> [Monetization](monetization-architecture.md) · [COMMERCIAL_MODEL](../ARCHIVE/LEGACY/COMMERCIAL_MODEL.md)
...
the single seeded local owner. See [Domain §Identity](domain-architecture.md) and
[Migration §Auth seam](migration-architecture.md).
