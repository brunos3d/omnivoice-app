...
**Reference docs:** [Product Architecture](../../ARCHITECTURE/product-architecture.md) (§4 feature flags, §4.2 deployment boundary), [Data Architecture](../../ARCHITECTURE/data-architecture.md) (§4 schema-ready tables), [Migration Architecture](../../ARCHITECTURE/migration-architecture.md) (§4, §7).
...
After this lands and the suite is green: **Phase 2 (Model Registry hardening)** then **Phase 3 (Voice/VoiceVariant split)** each get their own plan via the writing-plans skill, in that order (the critical path from [Roadmap §cross-phase order](../../ROADMAP/ROADMAP.md)).
