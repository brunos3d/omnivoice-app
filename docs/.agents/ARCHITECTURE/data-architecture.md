...
> **Voice Source Asset (future — [ADR-0010](../DECISIONS/adr-0010-voice-source-assets-and-automatic-variant-provisioning.md), schema deferred).**
...
>
> **Voice Creation Source (future — [ADR-0011](../DECISIONS/adr-0011-voice-creation-sources.md), schema deferred).**
...
| `status` | str | `pending`/`building`/`ready`/`failed`/`deprecated` — see [ADR-0008](../DECISIONS/adr-0008-voice-variant-build-lifecycle.md) for lifecycle |
...
#### 3.3.1 `voice_variant_artifacts` (artifact versioning — [ADR-0009](../DECISIONS/adr-0009-artifact-versioning-and-retention.md))
...
[Marketplace](marketplace-architecture.md).
...
[Monetization](monetization-architecture.md).
...
[Migration §DB](migration-architecture.md) and the existing
[DATA_MODEL](../ARCHIVE/LEGACY/DATA_MODEL.md).
