...
- **Follow-ups:** the additive metadata columns and the versioning rule are
  [Roadmap Phase 2](../ROADMAP/ROADMAP.md) and
  [Migration §5](../ARCHITECTURE/migration-architecture.md); variant staleness on `model.updated` ties to
  [ADR-0001](adr-0001-voice-variant-split.md).
