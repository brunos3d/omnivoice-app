...
- **Follow-ups:** drives the onboarding pipeline (build/regenerate variants), variant
  staleness on model updates ([ADR-0002](adr-0002-model-as-first-class-entity.md)), and the
  resolution logic in [API §3](../ARCHITECTURE/api-architecture.md). Migration detailed in
  [Migration §2](../ARCHITECTURE/migration-architecture.md).
